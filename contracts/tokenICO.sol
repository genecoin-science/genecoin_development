...
import "./CappedCrowdsale.sol"; // to be adjusted
import "./RefundableCrowdsale.sol"; // to be adjusted
import "./MintableToken.sol"; // to be adjusted


/**
 * @title tokenICO - based on SampleCrowdsaleToken from Open Zeppelin
